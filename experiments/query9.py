# Spatial roll-up just like Query 5 but with:
# - allows specification of results file
# - writes query states for each layer into a separate file
...
if len(sys.argv) >= 7:
    ...
    results_file = 'query9-results.txt'
